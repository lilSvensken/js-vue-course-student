    ...
    <div v-for="card in cards" :key="card.id" class="card">
      ...
      <div class="card-body">
        ...
        <div class="card__buttons">
          <button @click="increaseQuantity(card)" class="btn btn-primary button-plus">+</button>
          <button @click="decreaseQuantity(card)" class="btn btn-primary button-minus">-</button>
