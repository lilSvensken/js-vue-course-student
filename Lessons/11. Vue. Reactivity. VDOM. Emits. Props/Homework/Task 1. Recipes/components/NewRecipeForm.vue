<template>
  <div class="recipe-form">
    ...
    <div class="recipe-form__block">
      ...
      <textarea class="form-control recipe-form__ingredients" v-model="recipeIngredients"></textarea>
    </div>
    <div class="recipe-form__block">
      <label class="form-label">
        Последовательность действий
      </label>
      <textarea class="form-control recipe-form__text" v-model="recipeAction"></textarea>
    </div>
    <div class="recipe-form__block">
      <label class="form-label">
        Время приготовления
  ...
  computed: {
    selectedTime() {
      if (this.selectedOption) {
        return this.timeOptions.find(option => option.value === this.selectedOption).text;
      }
      return null
    }
  },
